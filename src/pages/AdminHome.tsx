...
import { Store, Plus, ChevronLeft, ToggleLeft, ChevronRight } from 'lucide-react';
...
export default function AdminHome() {
  ...
  useEffect(() => {
    (async () => {
      ...
      console.log('APP THINKS USER IS:', user);
      console.log('SUPABASE SESSION USER ID:', data.session?.user?.id);
      console.log('SUPABASE SESSION EMAIL:', data.session?.user?.email);
    })();
  }, [user]);
